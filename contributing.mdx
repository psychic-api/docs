---
title: "Contributing"
description: "Sidekick is open for contribution!"
---
...
## Other changes
For changes to other server-side code or the Sidekick modal or the Sidekick dashboard, please email us at support@getsidekick.ai. 

...
<img width="400" src="https://github.com/ai-sidekick/docs/assets/14931371/20137c7b-6995-4e6d-92f6-63443e5e68b0" />
</Accordion>

## Configuration

### Custom OAuth Credentials
By default, Sidekick will use our Confluence OAuth credentials to connect to your customer's accounts. If you want to use your own credentials instead, you can contact us at support@getsidekick.ai

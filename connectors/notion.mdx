...
The redirect URI is `https://dashboard.psychic.dev/oauth/redirect` if you are using Psychic's OAuth app. If you are using custom credentials, you'll need to set up your own endpoint to handle the redirect and auth code exchange.

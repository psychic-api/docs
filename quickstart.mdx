...
In this tutorial we will set up a connection with an API of your choice, use the Psychic Python SDK to fetch documents from that API, and use LangChain/Chroma/OpenAi to set up a retrieval service to ask questions about those documents. 

...
## Sidekick Cloud
Sidekick Cloud is the fastest way to get started querying your data from one or more data sources.

### 1. Create an account at [app.getsidekick.ai](https://app.getsidekick.ai/sign-in)

### 2. Choose the connector you want to sync data from and click `Authorize` to connect.
...
## Local setup
Sidekick can be set up locally, but requires quite a bit of work that's not fully documented here. [Join our Slack community](https://join.slack.com/t/sidekick-public/shared_invite/zt-1ra86qug3-~UWNCISLWpNj55Im6C6OaQ) to get help setting Sidekick up locally.

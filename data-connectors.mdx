...
<Note>The Sidekick app is still waiting on approval from Google, so your users will see a warning when they attempt to connect. You can bypass this by including instructions, or by using your own credentials for a Google app.</Note>
